      ...
      <header className="bg-gray-800 text-white py-4">
        ...
        {isOpen && (
          <nav className="sm:hidden mt-2 overflow-hidden z-10" >
            <a onClick={() => redireccion('home')} className="text-decoration-none block py-2 px-4 text-white hover:bg-gray-700">Home</a>
            <a onClick={() => redireccion('trips')} className="text-decoration-none block py-2 px-4 text-white hover:bg-gray-700">Trips</a>
