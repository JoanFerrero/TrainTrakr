const Footer = () => {
  return (
    <footer className="bg-gray-800 text-white body-font bottom-0 fixed left-0 w-full z-50">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
          ...
          <span className="ml-3 text-xl">Train Traker</span>
        </a>
        <p className="text-sm text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2024 TrainTraker</p>
