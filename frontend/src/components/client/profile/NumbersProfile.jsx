const NumbersProfile = ({NumberTrips, NumberNotification}) => {
  return (
        ...
        <div className="lg:w-1/2 lg:mr-4 flex items-center justify-center mt-2">
          <div className="bg-white p-4 rounded-lg shadow-md w-full">
            <div className="bg-white rounded-lg p-4 flex flex-col items-center justify-center">
              ...
              <button className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Ver Viajes</button>
            </div>
          </div>
        </div>
        <div className="lg:w-1/2 flex items-center justify-center mt-2">
          <div className="bg-white p-4 rounded-lg shadow-md w-full">
            <div className="bg-white rounded-lg p-4 flex flex-col items-center justify-center">
              ...
              <button className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Ver Notificaciones</button>
            </div>
          </div>
        </div>
      </div>
